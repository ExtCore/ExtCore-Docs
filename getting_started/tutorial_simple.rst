...
Open project.json file and add dependencies on ExtCore.WebApplication version 1.0.0-rc2 and on
...
Open project.json file and add dependency on ExtCore.Infrastructure version 1.0.0-rc2. After that
...
.. code-block:: js
    ...
    "dependencies": {
      "ExtCore.Infrastructure": "1.0.0-rc2",
